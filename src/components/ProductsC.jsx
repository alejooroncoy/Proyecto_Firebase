    ...
    return(
        <>
                ...
                <tbody>
                    <tr>
                        <td>
                            <img className="responsive-img rounded-lg" src={data.cover} alt={data.title}/>
                            <p className="p font-extrabold text-4xl">{data.title}</p>
                            <p className="p font-extrabold text-4xl">{`Costo: ${numero_p} soles`}</p>
                            <p className="p font-extrabold text-xl">{`Estás pidiendo ${data.cantidad} ${data.cantidad > 1 ? 'veces' : 'vez'} este mismo producto`}</p>
                            {
                                data.cantidad > 1 ?
